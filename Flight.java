...
public class Flight {
   ...
   protected String departLocation,
   					// Destination Airport
                    destination,
                    // Flight number, e.g. CS006, CS078, or CS388
                    flightNumber;
// Time of departure (Time object)
   protected Time departTime,
// Duration of flight (Time object)
                  duration;    
   ...
   public String toString() {
      return "\nFlight " + flightNumber + " departs " + departLocation + " for " + destination + " at " + departTime + "\n" ;
   }
}
